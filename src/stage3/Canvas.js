      ...
      <div style={{ width: canvasWidth, height: canvasHeight + 10, position: "relative" }}>
        {this.props.showInstructionCover &&
          <div className="instruction-cover">
            ...
            <ul>
              <li>The third “S” is <b>Straighten</b></li>
              <li>In Straighten, you will:</li>
              <ul>
                <li>Set items in order or store</li>
                <li>Arrange what is left after Sort and Safe stages to facilitate getting work done</li>
              </ul>
