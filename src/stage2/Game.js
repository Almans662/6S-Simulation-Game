...
let filenames = ["syringe_covered.png", "rx-square-1.png", "scissor.png", "rx-square-2.png"];
...
export default class extends Component {
  ...
  goToNextStage(e) {
    ...
    this.props.history.push("/stage3-cover");
  }
          ...
          <SideBar>
            ...
            <Instruction>
              ...
              <ul>
                ...
                <li>{this.state[[filenames[1]]]} Rx1 picked</li>
                <li>{this.state[[filenames[2]]]} scissor picked</li>
                <li>{this.state[[filenames[3]]]} Rx2 picked</li>
              </ul>
            </Instruction>
          </SideBar>
